...
import { buildChildren as buildMezzeChildren } from 'babel-type-mezze-jsx'
...
export default function (opts) {
  ...
  visitor.JSXNamespacedName = function (path) {
    throw path.buildCodeFrameError('Namespace tags are not supported. mezzeJSX is not XML.')
  }
  ...
  function buildElementCall (path, file) {
    path.parent.children = buildMezzeChildren(path.parent)
