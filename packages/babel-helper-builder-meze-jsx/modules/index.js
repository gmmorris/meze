...
import { buildChildren as buildMezeChildren } from 'babel-type-meze-jsx'
...
export default function (opts) {
  ...
  visitor.JSXNamespacedName = function (path) {
    throw path.buildCodeFrameError('Namespace tags are not supported. mezeJSX is not XML.')
  }
  ...
  function buildElementCall (path, file) {
    path.parent.children = buildMezeChildren(path.parent)
